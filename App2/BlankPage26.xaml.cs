...
namespace App2
{
    ...
    public sealed partial class BlankPage26 : Page
    {
        ...
        private void b1_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (kl == 1 && b1.Visibility == Visibility.Collapsed && b2.Visibility == Visibility.Collapsed && (suu == 0 || su == 0))
            {
                winer.Visibility = Visibility.Visible;
            }
            if (kl == 1 && b1.Visibility == Visibility.Collapsed && b2.Visibility == Visibility.Collapsed)
            {
        ...
        L:
            ...
            if (b1.Visibility == Visibility.Collapsed && b2.Visibility == Visibility.Collapsed)
            {
                winer.Visibility = Visibility.Visible;
                quit.Visibility = Visibility.Collapsed;
            }
            if (b1.Visibility == Visibility.Collapsed && b2.Visibility == Visibility.Collapsed && (su == 0 || suu == 0))
            {
                winer.Visibility = Visibility.Visible;
            }
            ...
            if (kl == 0 && (b1.Visibility == Visibility.Collapsed && b2.Visibility == Visibility.Collapsed))
            {
                quit.Visibility = Visibility.Collapsed;
                det.Interval = TimeSpan.FromSeconds(2);
                det.Tick += det_Tick;
